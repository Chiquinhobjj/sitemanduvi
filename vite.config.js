...
export default defineConfig(({ mode }) => {
  ...
  return {
    ...
    server: {
      ...
      strictPort: true,
      headers: {
        'Content-Security-Policy': "default-src 'self'; connect-src 'self' https://api.openai.com https://cdn.platform.openai.com https://sentinel.openai.com https://*.oaiusercontent.com https://browser-intake-datadoghq.com https://api-js.mixpanel.com; frame-src 'self' https://cdn.platform.openai.com https://sentinel.openai.com; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.platform.openai.com; style-src 'self' 'unsafe-inline'; img-src 'self' data: blob: https:; font-src 'self' https://cdn.openai.com; object-src 'none'; base-uri 'self'; form-action 'self';",
